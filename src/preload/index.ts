...
import type { BookRunnersApi, TimerTickPayload } from '@shared/ipcContract'
...
const api: BookRunnersApi = {
  profiles: {
    ...
    setAuthor: (name, author) => ipcRenderer.invoke(IPC.profiles.setAuthor, name, author),
