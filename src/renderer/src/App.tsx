...
import { SelectedBookView } from './components/readingnook/SelectedBookView'
...
const TAB_KEYS = { nook: 'tab_reading_nook', log: 'tab_library_log', about: 'tab_about' } as const
