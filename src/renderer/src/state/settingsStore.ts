...
export function applyThemeToDocument(settings: Settings): void {
  ...
  root.setProperty('--br-bg', colors.bg)
  root.setProperty('--br-panel', colors.panel)
  root.setProperty('--br-card', colors.card)
  root.setProperty('--br-text', colors.text)
  root.setProperty('--br-subtext', colors.subtext)
  root.setProperty('--br-accent', colors.accent)
  document.documentElement.style.setProperty('--br-font-scale', String(settings.fontScale))
