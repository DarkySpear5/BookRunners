...
/**
 * Footer-bearing dialogs (Modify, Settings, Add/Remove Time) put their
 * Save/Close bar as a sibling AFTER the scrollable body, both inside this
 * same flex column — so the footer never gets pushed off-screen by tall
 * content (a bug BookRunners v1 had before it fixed the ordering).
 */
